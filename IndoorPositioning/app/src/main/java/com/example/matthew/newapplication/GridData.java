...
public class GridData implements Comparable<GridData>  {
    ...
    public String printFullLocation() {return this.building+":"+this.floor+":"+Integer.toString(pos);}
    ...
    public ArrayList<RouterObject> getRouterArray() {return routerArray;}
    ...
    public void setCount(int number) {this.count = number;}
